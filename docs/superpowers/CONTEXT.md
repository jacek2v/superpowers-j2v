...
- **D-029** ✓ brainstorming deep research is propose-then-accept: skill proposes question list + mode + subagent count as its own message, dispatch only on approval — token spend needs consent [2026-07-28](specs/2026-07-28-brainstorming-subagent-research-design.md)
...
- **D-033** ✓ research mechanism lives in reference file `research-subagents.md` loaded on acceptance (visual-companion pattern) — keeps SKILL.md lean [2026-07-28](specs/2026-07-28-brainstorming-subagent-research-design.md)
